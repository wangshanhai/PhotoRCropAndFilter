...
public class ActivityGallery2 extends Activity implements
    ...
    public static void startWithUri(@NonNull Context context, @NonNull Uri uri) {
        Intent intent = new Intent(context, ActivityGallery2.class);
        intent.setData(uri);
...
*/
    ...
    private void initView() {
    	...
    	for (int i = 0; i < images.length; i++) {
			View view = LayoutInflater.from(this).inflate(R.layout.item_image2, null);

			RoundImageView imageview = (RoundImageView) view.findViewById(R.id.image_iv);
   ...
   /* private void initImages(Bitmap bitmap){
        ...
        for (int i = 0; i < images.length; i++) {
            ...
            GPUImageFilter filter = GPUImageFilterTools.createFilterForType(ActivityGallery2.this, filters.filters.get(i));
    ...
    public class ImageItemClick implements OnClickListener {
        ...
        public void onClick(View v) {
            if (clickPostion == 0) {
                ...
                GPUImageFilter filter = GPUImageFilterTools.createFilterForType(ActivityGallery2.this, filters.filters.get(clickPostion));
   ...
   /* private void initF(final Uri selectedImage) {
        for (int i = 0; i < images.length; i++) {
            View view = LayoutInflater.from(this).inflate(R.layout.item_image2, null);
