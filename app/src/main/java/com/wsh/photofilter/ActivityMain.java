...
import com.wsh.photofilter.filteractivity.ActivityCamera;
import com.wsh.photofilter.filteractivity.ActivityGallery2;
import com.wsh.photofilter.rcrop.SampleActivity;
...
public class ActivityMain extends Activity implements OnClickListener {
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        findViewById(R.id.rCorp).setOnClickListener(this);
    }
    ...
    public void onClick(final View v) {
        switch (v.getId()) {
            case R.id.button_gallery:
                startActivity(ActivityGallery2.class);
                break;
